...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (19103398,1150345,19103397,42374544,42374456,42952570,42952694)
...
WHERE C.value_as_number >= 1.2000
-- End Measurement Criteria
